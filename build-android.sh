...
echo 'Kompilowanie pliku binarnego android-arm...'
...
GOOS=android GOARCH=arm go build -o ./builds/android/Infinite-Bomber-arm/infinite-bomber -gcflags="all=-trimpath=$HOME" -asmflags="all=-trimpath=$HOME" -ldflags="-s -w"
...
echo 'Kompilowanie pliku binarnego android-arm64...'
...
echo 'Kompilowanie pliku binarnego dla systemu android-x86...'
...
echo 'Kompilowanie pliku binarnego dla systemu android-x64...'
